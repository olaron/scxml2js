...
var parallel = new FSM("parallel").addState(
new FSM("Parallel").addState(
new FSM("B").addState(
new FSM("BC").addTransition("b","BA",
[{"type" : "send","action" : {"event":"B",}},])
)
.addState(
new FSM("BB").addTransition("b","BC",
[{"type" : "send","action" : {"event":"B",}},])
)
.addState(
new FSM("BA").addTransition("b","BB",
[{"type" : "send","action" : {"event":"B",}},])
.addTransition("c","C",
...
.addState(
new FSM("A").addState(
new FSM("AB").addTransition("a","AC",
[{"type" : "send","action" : {"event":"A",}},])
)
.addState(
new FSM("AC").addTransition("a","AA",
[{"type" : "send","action" : {"event":"A",}},])
)
.addState(
...
new FSM("C"))
.addState(
new FSM("Start").addTransition("c","Parallel",
[{"type" : "send","action" : {"event":"C",}},])
)
